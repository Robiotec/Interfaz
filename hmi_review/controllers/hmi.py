...
#TODO: ==================================== Control de Luces ====================================
    ...
    def actualizar_intensidades(self):
        ...
        if not self.arduino_connected:
            print("No se ha podido establecer una conexión con Arduino.")
            return
        try:
    ...
    def salir(self):
        try:
            ...
            print(f"Error al intentar apagar la aplicación: {e}")
            QApplication.quit()  # Asegura que la aplicación se cierre en caso de error
