...
class Control(object):
    def setupUi(self, MainWindow):
        ...
        self.camera_label1 = QtWidgets.QLabel(self.frame_23)
        self.camera_label1.setObjectName("camera_label1")
        self.verticalLayout_17.addWidget(self.camera_label1)
